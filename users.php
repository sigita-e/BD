            ...
            <table class="table table-striped table-center">
                <thead>
                    <tr class="info">
                        ...
                        <th scope="col"><label>Epasts</label></th>
                        ...
                        <tr>
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                ...
                                <td><input hidden type="text" name="user_id" value=<?= $user->id ?>>
                                    <svg role="button" type="submit" class="btn-edit" name="edit" id="edit" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi-pencil" viewBox="0 0 16 16">
